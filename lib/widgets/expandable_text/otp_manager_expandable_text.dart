...
class OtpManagerExpandableText extends StatefulWidget {
  const OtpManagerExpandableText(
    this.text, {
    super.key,
  ...
  @override
  OtpManagerExpandableTextState createState() =>
      OtpManagerExpandableTextState();
}

class OtpManagerExpandableTextState extends State<OtpManagerExpandableText>
  ...
  @override
  void didUpdateWidget(OtpManagerExpandableText oldWidget) {
