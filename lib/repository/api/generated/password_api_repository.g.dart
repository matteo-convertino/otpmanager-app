...
part of '../password_api_repository.dart';
...
class _PasswordApiRepository implements PasswordApiRepository {
  _PasswordApiRepository(this._dio, {this.baseUrl, this.errorLogger});
